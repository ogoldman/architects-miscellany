...
An architecture is similar to a _design language_.
However, design languages tend to place an emphasis on construction (available elements, and how they can be combined) and less so on contraints.
(See link:../books/Winograd96[Winograd96], Chapter 4.)
